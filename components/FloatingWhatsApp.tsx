  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <motion.a
        ...
        className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:scale-110 transition-transform duration-300 group"
      ...
      >
        {/* Pulse ring */}
        <div className="absolute inset-0 rounded-full border-2 border-[#25D366] ping-red pointer-events-none" />
